...
const arcadeButtons = [
  { label: "THE STORY OF LIFE", to: "/games/boss", color: "#FF1744", key: 'boss' }
];
    ...
    <Box sx={{
      ...
      <style>{`
        @keyframes greenPulse {
          ...
          25% { background-position: 25% 50%; filter: brightness(1.1); }
          50% { background-position: 50% 50%; filter: brightness(1.2); }
          75% { background-position: 75% 50%; filter: brightness(1.1); }
        ...
        <Box sx={{ mb: 4 }}>
          <Box sx={{ display: 'flex', justifyContent: 'center', gap: 2, mb: 3 }}>
            <Button
              ...
              variant={activeSection === 'casino' ? 'contained' : 'outlined'}
              sx={{
                color: activeSection === 'casino' ? '#fff' : '#fff',
            ...
            <Button
              ...
              variant={activeSection === 'arcade' ? 'contained' : 'outlined'}
              sx={{
                color: activeSection === 'arcade' ? '#fff' : '#fff',
                borderColor: 'rgba(255,255,255,0.8)',
                fontWeight: 700,
                '&:hover': {
                  background: 'rgba(255,255,255,0.15)',
